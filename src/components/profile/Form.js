...
export default function Form() {
  ...
  return (
    <form className='flex flex-col w-4/6 lg:w-3/6'>
        ...
        <div className='flex flex-row justify-center py-4'>
            <input type='submit' value='SAVE' className='bg-[#4699C2] text-white fong-bold w-24 py-3 rounded-full mx-4 font-bold hover:bg-[#026FC2] hover:shadow-lg focus:bg-[#026FC2] focus:shadow-lg focus:outline-none focus:ring-0 active:bg-[#026FC2] active:shadow-lg transition duration-150 ease-in-out'/>
            <input
            type='reset' 
            value='CANCEL' 
            className='bg-[#4699C2] lg:bg-white hover:bg-[#026FC2] hover:text-white hover:shadow-lg focus:bg-[#026FC2] focus:shadow-lg focus:outline-none focus:ring-0 focus:text-white active:bg-[#026FC2] active:shadow-lg transition duration-150 ease-in-out text-white lg:text-[#4699C2] lg:border lg:border-[#4699C2] fong-bold w-24 py-3 rounded-full font-bold'/>
        </div>
    </form>
  )
}