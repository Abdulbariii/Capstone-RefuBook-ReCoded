...
function Authentication({ signUpIn, isMember, memberStatus }) {
    ...
    return (
        <section className='flex flex-col'>
            ...
            <div className="z-20 lg:m-auto lg:p-9 lg:mt-48 mt-24 mx-10 p-16 flex flex-col justify-between items-center lg:gap-6 text-center bg-white shadow-[2px_4px_8px_rgba(0,0,0,0.3)] rounded-3xl ">
                <p className='text-[#4699C2] font-sans font-bold lg:text-2xl text-lg text-center'>{signUpIn}</p>
                <div className='flex lg:flex-row flex-col justify-between items-center lg:gap-10 '>
                    <button onClick={GoogleLogin} type="button" className="px-16 py-2   mt-5 bg-[#eb5757] text-white font-bold lg:text-lg text-base rounded-full shadow-md hover:bg-[#df3535] hover:shadow-lg focus:bg-[#df3535] focus:shadow-lg focus:outline-none focus:ring-0 active:bg-[#df3535] active:shadow-lg transition duration-150 ease-in-out">
                ...
                <div className="lg:static absolute bottom-[15%] flex lg:flex-row flex-col justify-center items-center lg:gap-0 gap-2">
                    <p className='lg:text-[#a5e7fa] text-[#70CDD6] font-sans font-bold text-lg text-center'>{isMember}</p>
